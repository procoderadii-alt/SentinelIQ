...
class District(Base, TimestampMixin):
    ...
    polygon_geometry: Mapped[str | None] = mapped_column(Text, nullable=True) # GeoJSON string
...
class Case(Base, TimestampMixin):
    ...
    assigned_to_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), ForeignKey("users.id"), nullable=True, index=True)
...
class CrimeRecord(Base, TimestampMixin):
    ...
    source_dataset_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), ForeignKey("datasets.id"), nullable=True, index=True)
    ...
    case: Mapped[Case | None] = relationship("Case", back_populates="crime_records")
    source_dataset: Mapped["Dataset" | None] = relationship("Dataset", back_populates="crime_records")
...
class Victim(Base, TimestampMixin):
    ...
    crime_record_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), ForeignKey("crime_records.id"), nullable=True, index=True)
    
    crime_record: Mapped[CrimeRecord | None] = relationship("CrimeRecord", back_populates="victims")
...
class Suspect(Base, TimestampMixin):
    ...
    crime_record: Mapped[CrimeRecord | None] = relationship("CrimeRecord", back_populates="suspects")
    case: Mapped[Case | None] = relationship("Case", back_populates="suspects")
...
class Vehicle(Base, TimestampMixin):
    ...
    suspected_crime_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), ForeignKey("crime_records.id"), nullable=True, index=True)
    
    suspected_crime: Mapped[CrimeRecord | None] = relationship("CrimeRecord", back_populates="vehicles")
...
class Phone(Base, TimestampMixin):
    ...
    suspected_crime: Mapped[CrimeRecord | None] = relationship("CrimeRecord", back_populates="phones")
...
class EmergencyCall(Base, TimestampMixin):
    ...
    dispatch_unit_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), ForeignKey("patrol_units.id"), nullable=True, index=True)
    
    dispatch_unit: Mapped[PatrolUnit | None] = relationship("PatrolUnit")
