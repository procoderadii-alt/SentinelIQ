...
def seed_database(db: Session, crimes: int = 50000, offenders: int = 5000, districts: int = 100, gangs: int = 500, emergency_calls: int = 10000, cctv_events: int = 20000) -> None:
    ...
    role_permissions_map = {
        ...
        "Intelligence Officer": ["View Data", "Edit Data", "Access AI Services"],
        "District Officer": ["View Data", "Edit Data", "Generate Reports"],
        "Investigator": ["View Data", "Edit Data"],
    ...
    admin_user = User(
        ...
        full_name="SentinelIQ Administrator",
    ...
    analyst_user = User(
        email="analyst@sentineliq.local",
        full_name="SentinelIQ Analyst",
        hashed_password=hash_password("SentinelIQ@123"),
        role=role_dict["Analyst"]
    )
    db.add(analyst_user)
    db.flush()
    ...
    print("Generating 100 Districts...")
    districts_list = []
    ...
    print("Generating 5000 Offenders...")
    offenders_data = []
    ...
    print("Bulk Seeding 50,000 Crime Records (this may take a moment)...")
    ...
    print("Generating 10,000 Emergency Calls...")
    ...
    print("Generating 20,000 CCTV Events...")
    cctv_logs = [
